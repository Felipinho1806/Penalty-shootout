...
public class Shootout {
    ...
    private ArrayList<String> jogadoresCroacia = new ArrayList<>(Arrays.asList(
        "Livakovic",
        "Juranovic",
        "Lovren",
        "Gvardiol",
    ...
    public ArrayList<String> getJogadoresCroacia() {
        return jogadoresCroacia;
    }
    public void setJogadoresCroacia(ArrayList<String> jogadoresCroacia) {
        this.jogadoresCroacia = jogadoresCroacia;
    }
    ...
    public int chuteCroacia() {
        ...
        // Exibir o canto escolhido pelo chute da Croácia e pelo goleiro
